...
class TestNodeDeepening(unittest.TestCase):
    def test_command(self):
        # KGCL statement
        command = "deepen <http://example.org/targetClass> from <http://example.org/superclass>"
        command += " to <http://example.org/subclass>"
...
class TestNodeShallowing(unittest.TestCase):
    def test_command(self):
        # KGCL statement
        command = "shallow <http://example.org/targetClass> from <http://example.org/subclass>"
        command += " to <http://example.org/superclass>"
...
class TestNodeMove(unittest.TestCase):
    def test_command(self):
        # KGCL statement
        command = "move <http://example.org/targetClass> from <http://example.org/A>"
        command += " to <http://example.org/B>"
...
class TestEdgeCreation(unittest.TestCase):
    def test_command(self):
        # KGCL statement
        command = "create edge <http://example.org/predicate> from <http://example.org/subject>"
        command += " to <http://example.org/object>"
...
class TestEdgeDeletion(unittest.TestCase):
    def test_command(self):
        # KGCL statement
        command = "delete edge <http://example.org/predicate> from <http://example.org/subject>"
        command += " to <http://example.org/object>"
